...
impl StructurePieceBase for JungleTemplePiece {
    ...
    fn place(
        ...
        if !self.placed_trap_1 {
            self.placed_trap_1 = self.piece.add_loot_container(
                chunk,
                bb,
                random,
                3,
        ...
        if !self.placed_trap_2 {
            self.placed_trap_2 = self.piece.add_loot_container(
                chunk,
                bb,
                random,
                9,
        ...
        if !self.placed_main_chest {
            self.placed_main_chest = self.piece.add_chest(
                chunk,
                bb,
                random,
                8,
        ...
        if !self.placed_hidden_chest {
            self.placed_hidden_chest = self.piece.add_chest(
                chunk,
                bb,
                random,
                9,
...
impl JungleTemplePiece {
    fn dispenser_facing(facing: Facing) -> &'static BlockState {
        ...
        BlockState::from_id(props.to_state_id(&Block::DISPENSER))
    }
