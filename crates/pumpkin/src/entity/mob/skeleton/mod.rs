...
use crate::entity::{
    ...
    ai::goal::{
        active_target::ActiveTargetGoal, bow_attack::BowAttackGoal, flee_sun::FleeSunGoal,
...
impl SkeletonEntityBase {
    pub fn new(entity: Entity) -> Arc<Self> {
        ...
        };
        {
            ...
            goal_selector.add_goal(2, Box::new(RestrictSunGoal::new(mob_weak.clone())));
            goal_selector.add_goal(3, Box::new(FleeSunGoal::new(mob_weak.clone(), 1.0)));
